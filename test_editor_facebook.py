"""测试获取1月5号剪辑师Facebook数据"""
import asyncio
import sys
sys.path.insert(0, '.')

from xmp.xmp_scheduler import fetch_editor_facebook_stats
...
async def main():
    print("=" * 60)
    print("测试获取 2026-01-05 剪辑师 Facebook 数据")
    print("=" * 60)

    data = await fetch_editor_facebook_stats(BEARER_TOKEN, "2026-01-05")
